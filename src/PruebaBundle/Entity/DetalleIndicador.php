 ...
 * DetalleIndicador
 *
 * @ORM\Table(name="detalle_indicador")
 * @ORM\Entity(repositoryClass="PruebaBundle\Repository\DetalleIndicadorRepository")
 */
class DetalleIndicador
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Indicador", inversedBy="detallesIndicador")
